...
\]
The repository contains the explicit orthogonality graphs and exact clique computations used in \cref{lem:exotic-root-types}. In particular, after the Aristotle audit patch, the two chain cases are recorded with corrected orthogonal root counts $48$ and $32$ and maximal orthogonal size $4$ in each case.
