...
GitHub-ready reproducibility repository for the paper **"On the number of singular points of rank-one klt del Pezzo surfaces in characteristic 3"**.
...
The current paper files are in `paper/`. The strongest referee-facing draft in this repository is `paper/N_le_7_char3_paper_draft_v7.tex` and its compiled PDF.
